...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Ingrese el nombre de la persona:");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/surveys", "root", "");
            PreparedStatement pst = cn.prepareStatement("select * from Names where ID = ?");
            ...
            if(rs.next()){
                ...
                txt_date.setText(rs.getString("Date_of_bith"));
